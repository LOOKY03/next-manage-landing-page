    ...
    <div>
      <div className="container mx-auto ">
        ...
        <main className="container mx-auto ">
          <TopNavBar />
          <div className="grid grid-cols-1 lg:grid-cols-2 pt-20 px-5 lg:px-0">
            {/* left */}
            <div className="text-neutral-800 pt-20 text-center lg:text-left order-last lg:order-first">
              <h1 className="text-5xl font-bold lg:w-96">
                Bring everyone together to build better products.
              </h1>
              <p className="text-md pt-10 lg:w-96">
                Manage makes it simple for software teams to plan day-to-day
                task while keeping the larger team goals in view.
              </p>
              <button className="bg-orange-500 text-white px-4 py-2 rounded-full mt-10">
                Get Started
              </button>
            </div>
        ...
        <div className="container mx-auto pt-10 px-5">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="text-center lg:w-96 lg:text-left">
              ...
              <p>
                ...
                the complexity. Our software is tailor-mode for modern digital
                product team
              </p>
            </div>
            {/* right */}
            <div className="pt-10 grid">
              <div>
                <h1 className="font-bold bg-orange-300 rounded-full lg:bg-white">
                  <span>
                    <button className="bg-orange-500 p-1 px-3 rounded-full mr-2 text-white">
                      01
                    </button>
                  </span>
                  Track the company-wide progress
                </h1>
                <p className="ml-12">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Possimus ipsum incidunt quasi sit ratione neque. Laudantium
                  unde accusantium eveniet, corporis quae illum nihil maiores
                  autem fuga at quisquam, qui amet!
                </p>
              </div>
              <div className="mt-10">
                <h1 className="font-bold bg-orange-300 rounded-full lg:bg-white">
          ...
          <div className="container mx-auto relative">
            ...
            <div
              className="flex justify-between overflow-hidden scroll-smooth pt-16 "
              ref={ref}
            >
              <div className="w-96 px-2 bg-gray-100 mx-2 py-5 relative">
                <img
                  src="/images/avatar-anisha.png"
                  alt=""
                  className="h-16 absolute -top-7 left-40"
                />
                <p className="text-center font-bold pt-10">Anisha Li</p>
                <h1 className="w-96 text-center px-2 mt-5">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa
                  obcaecati accusamus fugiat cumque enim. Quis labore dolorum
                  dolorem, quae,
                </h1>
              </div>
              <div className="w-96 px-2 bg-gray-100 mx-2 py-5 relative">
                <img
                  ...
                  className="h-16 absolute -top-7 left-40"
                />
                <p className="text-center font-bold pt-10">Ali Bravo</p>
              ...
              <div className="w-96 px-2 bg-gray-100 mx-2 py-5 relative">
                <img
                  ...
                  className="h-16 absolute -top-7 left-40"
                />
                <p className="text-center font-bold pt-10">Richard Watts</p>
                <h1 className="w-96 text-center px-2 mt-5">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa
                  obcaecati accusamus fugiat cumque enim. Quis labore dolorum
                  dolorem, quae,
              ...
              <div className="w-96 px-2 bg-gray-100 mx-2 py-5 relative">
                <img
                  ...
                  className="h-16 absolute -top-7 left-40"
                />
                <p className="text-center font-bold pt-10">Shanai Gough</p>
                <h1 className="w-96 text-center px-2 mt-5">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa
                  obcaecati accusamus fugiat cumque enim. Quis labore dolorum
                  dolorem, quae,
            ...
            <span
              className="cursor-pointer absolute top-48"
              onClick={() => scroll(-300)}
            >
              <ArrowBackIosIcon />
            </span>
            <span
              className="cursor-pointer absolute top-48 right-0"
              onClick={() => scroll(300)}
            >
              <ArrowForwardIosIcon />
            </span>
      ...
      <footer className="bg-stone-900 ">
        <div className="container mx-auto grid grid-cols-2 pt-16 pb-16 pl-14 lg:pl:0">
          <div className="flex justify-around">
            <div className="flex flex-col">
              ...
              {/* icon logos */}
              <div className="text-white flex flex-row mt-20 space-x-2">
            ...
            <div className="text-white space-y-2 ml-10">
              <p>Home</p>
              <p>Pricing</p>
              <p>Products</p>
              <p>About Us</p>
          ...
          <div className="flex justify-around">
            <div className="text-white pl-8 lg:pl-0">
              <p>Careers</p>
              <p>Community</p>
              <p>Privacy Policy</p>
            </div>
            <div className="hidden lg:block">
              <input
                ...
                className="w-40 py-1 px-2 rounded-full mr-2 text-sm"
              />
              <button className="text-white bg-orange-600 px-4 py-1 rounded-full">
                Go
              </button>
            </div>
          </div>
